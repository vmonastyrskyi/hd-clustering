...
class KMeans {
    constructor(vector, options, callback) {
        ...
        this.distanceFunction = this.options.distance || euclideanDistance;
...
exports.clustering = (vector, options, callback) => {
    return new KMeans(vector, options, callback);
};

exports._class = KMeans;
